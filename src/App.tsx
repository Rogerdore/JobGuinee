...
const AdminOGTemplate = lazy(() => import('./pages/AdminOGTemplate'));
  ...
  if (isAdminPage) {
    return (
      <AdminLayout currentPage={currentPage} onNavigate={handleNavigate} activeParam={userManagementFilter}>
        ...
        {currentPage === 'admin-template-affiche' && <AdminOGTemplate />}
