...
import { Menu, X, Briefcase, User, LogOut, Home, BookOpen, Users, FileText, ChevronDown, LayoutDashboard, Settings, Building2, Handshake } from 'lucide-react';
...
export default function Layout({ children, currentPage, onNavigate }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Partenaires', page: 'partner-hub', icon: Handshake },
