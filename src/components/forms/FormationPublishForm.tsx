    ...
    try {
      ...
      if (data) {
        setCommonData({
          ...
          trainer_contact_name: data.trainer_contact_name || '',
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-6 pt-6 border-t">
            <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              ...
              <span className="text-sm font-normal text-orange-600">(Obligatoire - Pour les paiements)</span>
            </h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 border-2 border-blue-200 rounded-xl p-6">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-blue-900 mb-2">Important: Contact Direct</h4>
                  <p className="text-sm text-blue-800 leading-relaxed">
                    Les inscriptions et paiements se font directement avec vous. Les candidats vous contacteront par téléphone ou WhatsApp pour discuter des modalités.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 mt-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={commonData.trainer_contact_name}
                    onChange={(e) => setCommonData({ ...commonData, trainer_contact_name: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                    placeholder="Ex: Dr. Mamadou Sow"
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Le nom qui sera affiché aux candidats</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="tel"
                    value={commonData.trainer_phone}
                    onChange={(e) => setCommonData({ ...commonData, trainer_phone: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                    placeholder="Ex: 622123456"
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">Les candidats pourront vous appeler ou vous contacter via WhatsApp</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="email"
                    value={commonData.trainer_email}
                    onChange={(e) => setCommonData({ ...commonData, trainer_email: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                    placeholder="Ex: contact@formation.gn"
                  />
                  <p className="text-xs text-gray-500 mt-1">Optionnel - Pour recevoir des demandes par email</p>
                </div>
              </div>
            </div>
          </div>
