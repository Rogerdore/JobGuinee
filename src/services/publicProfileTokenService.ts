  ...
  private async fetchCandidateProfile(candidateId: string): Promise<PublicProfileData> {
    try {
      ...
      return {
        ...
        email: profile?.email,
        professional_title: candidateProfile?.titre_professionnel,
        phone: candidateProfile?.telephone,
        location: candidateProfile?.lieu,
        profile_photo_url: candidateProfile?.profile_photo_url,
        professional_summary: candidateProfile?.resume_professionnel,
        experiences: candidateProfile?.experiences || [],
        education: candidateProfile?.formations || [],
        skills: candidateProfile?.competences || [],
        languages: candidateProfile?.langues || [],
