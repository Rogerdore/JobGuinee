/*
  # Add Premium Subscription to Companies

  1. Changes
    - Add `subscription_tier` column to companies table (free, premium, enterprise)
    - Add `subscription_start_date` to track when premium started
    - Add `subscription_end_date` to track when premium expires
