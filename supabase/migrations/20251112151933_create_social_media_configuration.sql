...
DROP POLICY IF EXISTS "Tout le monde peut lire la configuration des réseaux sociaux" ON social_media_configuration;
CREATE POLICY "Tout le monde peut lire la configuration des réseaux sociaux"
  ON social_media_configuration FOR SELECT
  TO authenticated
  USING (true);

DROP POLICY IF EXISTS "Public peut lire la configuration des réseaux sociaux" ON social_media_configuration;
CREATE POLICY "Public peut lire la configuration des réseaux sociaux"
  ON social_media_configuration FOR SELECT
  TO anon
  USING (true);

DROP POLICY IF EXISTS "Seuls les admins peuvent insérer la configuration" ON social_media_configuration;
...
DROP POLICY IF EXISTS "Seuls les admins peuvent modifier la configuration" ON social_media_configuration;
...
DROP POLICY IF EXISTS "Seuls les admins peuvent supprimer la configuration" ON social_media_configuration;
...
DROP TRIGGER IF EXISTS update_social_media_configuration_updated_at_trigger ON social_media_configuration;
...
-- Insérer une configuration par défaut avec tous les réseaux ACTIVÉS
