/*
  # Create IA Service Configuration System

  1. New Tables
    - ia_service_config: Configuration for each IA service (prompts, params)
    - ia_service_config_history: Version history and audit trail
...
DROP TRIGGER IF EXISTS update_ia_service_config_updated_at ON ia_service_config;
CREATE TRIGGER update_ia_service_config_updated_at
  BEFORE UPDATE ON ia_service_config
  FOR EACH ROW
