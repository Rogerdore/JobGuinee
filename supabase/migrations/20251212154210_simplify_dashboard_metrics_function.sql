/*
  # Simplification de la fonction get_recruiter_dashboard_metrics
  
  1. Problème
    - La fonction utilise `workflow_history` qui n'existe pas
    
  2. Correction
    - Retirer la partie calcul de délai moyen (mettre 0 pour l'instant)
    - Garder toutes les autres métriques
*/
...
BEGIN
  ...
  -- 4. Délai moyen - temporairement à 0 (pas de workflow_history)
  avg_time_days := 0;
